...
2. [All About React Router 4](https://css-tricks.com/react-router-4/)

3. [Build your own React Router v4](https://tylermcginnis.com/build-your-own-react-router-v4/)
...
#### javascript 正则表达式
1. [A GUIDE TO JAVASCRIPT REGULAR EXPRESSIONS](https://flaviocopes.com/javascript-regular-expressions/)
...
2. [Git Cheat Sheet 中文版](https://github.com/arslanbilal/git-cheat-sheet/blob/master/other-sheets/git-cheat-sheet-zh.md)
3. [一个成功的Git分支模型](https://blog.csdn.net/dbzhang800/article/details/6798724)
