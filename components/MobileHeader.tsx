...
const MobileHeader = (props: Props) => {
  ...
  return (
    <div
      className={cn(
        "sticky top-0 pt-3 pb-2 sm:pt-2 sm:mb-1 bg-white dark:bg-zinc-900 bg-opacity-80 backdrop-blur-lg flex md:hidden flex-row justify-between items-center w-full h-auto flex-nowrap shrink-0 z-1",
